...
const SignIn: FC = () => {
  ...
  return (
    <main className="min-h-screen flex flex-col justify-center items-center pb-20">
      <h1 className="text-2xl font-bold">Hunter_JOE's Board Sign In</h1>
      <form className="mt-8 flex items-end gap-4" onSubmit={onSubmitSignIn}>
        <div className="flex flex-col gap-2 relative">
          ...
          />
          <Link to="/sign-up" className="absolute -bottom-5 left-2 text-xs text-blue-500 active:text-blue-700">
            Create an account
          </Link>
        </div>
